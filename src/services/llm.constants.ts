...
export const LLM_VALIDATION_FALLBACK_HINTS = {
	timeout:
		"The validation request timed out before the provider returned a response.",
	aborted: "The validation request was aborted before a response was received.",
	network:
		"The provider could not be reached. Check network access and the configured base URL.",
	invalidPayload:
