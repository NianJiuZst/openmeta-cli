...
export const IssueMatchListSchema = z.object({
	matches: z
		...
		.transform((matches) => {
			...
			return [...dedupedMatches.values()].sort(
...
export const IssueMatchListEnvelopeSchema =
	createStructuredOutputEnvelopeSchema(
		"issue_match_list",
		IssueMatchListSchema,
	);
export const PatchDraftEnvelopeSchema = createStructuredOutputEnvelopeSchema(
	"patch_draft",
	PatchDraftSchema,
);
export const ImplementationDraftEnvelopeSchema =
	createStructuredOutputEnvelopeSchema(
		"implementation_draft",
		ImplementationDraftSchema,
	);
export const PullRequestDraftEnvelopeSchema =
	createStructuredOutputEnvelopeSchema(
		"pull_request_draft",
...
export type IssueMatchListEnvelope = z.infer<
	typeof IssueMatchListEnvelopeSchema
>;
export type PatchDraftEnvelope = z.infer<typeof PatchDraftEnvelopeSchema>;
export type ImplementationDraftEnvelope = z.infer<
	typeof ImplementationDraftEnvelopeSchema
>;
export type PullRequestDraftEnvelope = z.infer<
	typeof PullRequestDraftEnvelopeSchema
>;
