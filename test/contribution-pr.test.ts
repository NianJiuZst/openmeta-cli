		...
		service.initialize({
			rest: {
				...
				pulls: {
					list: async () => ({ data: [] }),
					create: async () => ({
						data: { html_url: 'https://github.com/acme/demo/pull/10', number: 10 },
					}),
				},
				git: {
					createTree: async () => ({ data: { sha: 'tree-sha' } }),
		...
		service.initialize({
			rest: {
				...
				pulls: {
					list: async () => ({ data: [] }),
					create: async () => ({
						data: { html_url: 'https://github.com/acme/demo/pull/11', number: 11 },
					}),
				},
				git: {
					createTree: async () => ({ data: { sha: 'tree-sha' } }),
		...
		service.initialize({
			rest: {
				...
				pulls: {
					list: async () => ({ data: [] }),
					create: async () => ({
						data: { html_url: 'https://github.com/acme/demo/pull/12', number: 12 },
					}),
				},
				git: {
					createTree: async () => ({ data: { sha: 'tree-sha' } }),
